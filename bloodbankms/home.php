  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image\donor.png" alt="image\donor.png" width="100%" height="500">
      </div>
      ...
      <div class="carousel-item">
        <img src="image\save.jpg" alt="image\save.jpg" width="100%" height="500">
      </div>
...
<br>
        <h1 style="text-align:center;font-size:45px;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Welcome to Blood Bank & Donor Management System</h1>
<br>
        <div class="row">
